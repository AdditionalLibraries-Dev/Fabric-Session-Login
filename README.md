...
![GitHub Downloads](https://img.shields.io/github/downloads/AdditionalLibraries-Dev/Fabric-Session-Login/total?style=for-the-badge)
...
|-------------------|------------|----------------------------------------------------------------------|
| 1.21.11+          | `main`     | [View Branch](https://github.com/AdditionalLibraries-Dev/Fabric-Session-Login/tree/main)     |
...
1. Download the mod `.jar` from [Releases](https://github.com/AdditionalLibraries-Dev/Fabric-Session-Login/releases)
